...
public class MultiplyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_multiply, container, false);
        t1 = v.findViewById(R.id.textMultiply);
        Bundle b3 = getArguments();
        String Num1 = b3.getString("Num1");
        String Num2 = b3.getString("Num2");
        int n1,n2,tot;
